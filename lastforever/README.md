...
dotnet anchorgen -i target/idl/lastforever.json -o target/idl/Lastforever.cs
```

(Replace lastforever with the name of your program)
...
useEffect(() => {
    ...
    const [pda] = PublicKey.findProgramAddressSync(
        ...
        publicKey.toBuffer()],
        new PublicKey(Lastforever_PROGRAM_ID)
      );
    try {
