...
public class AnchorService : MonoBehaviour
{
    ...
    private async void OnLogin(Account account)
    {
        ...
        anchorClient = new LastforeverClient(Web3.Rpc, Web3.WsRpc, AnchorProgramIdPubKey);
    ...
    public async void ChopTree(bool useSession, Action onSuccess)
    {
        ...
        if (useSession)
        {
            ...
            var chopInstruction = LastforeverProgram.ChopTree(chopTreeAccounts, levelSeed, transactionCounter, AnchorProgramIdPubKey);
