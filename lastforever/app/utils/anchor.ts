...
import { Lastforever, IDL } from "../idl/lastforever"
...
export const program = new Program<Lastforever>(IDL, programId, {
...
export type PlayerData = IdlAccounts<Lastforever>["playerData"]
export type GameData = IdlAccounts<Lastforever>["gameData"]
